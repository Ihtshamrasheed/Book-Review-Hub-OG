...
<div class="container content mt-4">
  ...
  <input type="text" name="search" class="form-control mr-2 "style="margin-top: 18px;" placeholder="Search books..." value="<?= htmlspecialchars($_GET['search'] ?? '') ?>">
    ...
    <a href="add_book.php" class="btn btn-primary ">Add a Book</a>
      ...
      <div class="col-md-3">
        <div class="book-tile">
          ...
          <div class="options-menu">
            <a href="update_book.php?id=<?= $book['Book_ID'] ?>">Update Book</a>
            <a href="delete_book.php?id=<?= $book['Book_ID'] ?>" onclick="return confirm('Are you sure?')">Delete Book</a>
          </div>
        </div>
      </div>
    <?php endforeach; ?>
